...
export default function About() {
  return (
    <div className="p-6 max-w-3xl mx-auto">
      <PageHeader title="About FinanceOS" subtitle="Your intelligent personal finance companion" />
      <div className="space-y-4">
        <GlassCard className="p-6 text-center" delay={0}>
          ...
          <h2 className="text-xl font-bold text-foreground">FinanceOS</h2>
        ...
        <GlassCard className="p-5 text-center" delay={5}>
          <p className="text-sm text-muted-foreground">Built with ❤️ using React, Vite, Tailwind CSS & Recharts</p>
          <p className="text-xs text-muted-foreground mt-1">© 2025 FinanceOS. All rights reserved.</p>
        </GlassCard>
      </div>
    </div>
  );
